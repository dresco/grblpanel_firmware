...
void quadrature_tim2_ll_init(void)
{
  ...
  LL_TIM_IC_SetPrescaler(TIM2, LL_TIM_CHANNEL_CH1, IC_PRESCALER);
  LL_TIM_IC_SetFilter(TIM2, LL_TIM_CHANNEL_CH1, IC_FILTER);
  LL_TIM_IC_SetPolarity(TIM2, LL_TIM_CHANNEL_CH1, LL_TIM_IC_POLARITY_RISING);
  LL_TIM_IC_SetActiveInput(TIM2, LL_TIM_CHANNEL_CH2, LL_TIM_ACTIVEINPUT_DIRECTTI);
  LL_TIM_IC_SetPrescaler(TIM2, LL_TIM_CHANNEL_CH2, IC_PRESCALER);
  LL_TIM_IC_SetFilter(TIM2, LL_TIM_CHANNEL_CH2, IC_FILTER);
...
void quadrature_tim3_ll_init(void)
{
  ...
  LL_TIM_IC_SetPrescaler(TIM3, LL_TIM_CHANNEL_CH1, IC_PRESCALER);
  LL_TIM_IC_SetFilter(TIM3, LL_TIM_CHANNEL_CH1, IC_FILTER);
  LL_TIM_IC_SetPolarity(TIM3, LL_TIM_CHANNEL_CH1, LL_TIM_IC_POLARITY_RISING);
  LL_TIM_IC_SetActiveInput(TIM3, LL_TIM_CHANNEL_CH2, LL_TIM_ACTIVEINPUT_DIRECTTI);
  LL_TIM_IC_SetPrescaler(TIM3, LL_TIM_CHANNEL_CH2, IC_PRESCALER);
  LL_TIM_IC_SetFilter(TIM3, LL_TIM_CHANNEL_CH2, IC_FILTER);
...
void quadrature_tim4_ll_init(void)
{
  ...
  LL_TIM_IC_SetPrescaler(TIM4, LL_TIM_CHANNEL_CH1, IC_PRESCALER);
  LL_TIM_IC_SetFilter(TIM4, LL_TIM_CHANNEL_CH1, IC_FILTER);
  LL_TIM_IC_SetPolarity(TIM4, LL_TIM_CHANNEL_CH1, LL_TIM_IC_POLARITY_RISING);
  LL_TIM_IC_SetActiveInput(TIM4, LL_TIM_CHANNEL_CH2, LL_TIM_ACTIVEINPUT_DIRECTTI);
  LL_TIM_IC_SetPrescaler(TIM4, LL_TIM_CHANNEL_CH2, IC_PRESCALER);
  LL_TIM_IC_SetFilter(TIM4, LL_TIM_CHANNEL_CH2, IC_FILTER);
...
void quadrature_tim5_ll_init(void)
{
  ...
  LL_TIM_IC_SetPrescaler(TIM5, LL_TIM_CHANNEL_CH1, IC_PRESCALER);
  LL_TIM_IC_SetFilter(TIM5, LL_TIM_CHANNEL_CH1, IC_FILTER);
  ...
  LL_TIM_IC_SetPrescaler(TIM5, LL_TIM_CHANNEL_CH2, IC_PRESCALER);
  LL_TIM_IC_SetFilter(TIM5, LL_TIM_CHANNEL_CH2, IC_FILTER);
